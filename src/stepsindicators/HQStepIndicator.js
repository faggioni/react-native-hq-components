...
export default class HQStepIndicator extends Component {
    ...
    render() {
        ...
        return (
            <View style={[styles.container, direction === 'vertical' ? {
                flexDirection: 'row',
                flex: 1
    ...
    renderStepIndicator = () => {
        ...
        for (let position = 0; position < stepCount; position++) {
            steps.push(
                <TouchableWithoutFeedback key={position} onPress={() => this.stepPressed(position)}>
                    <View
                        style={[styles.stepContainer, direction === 'vertical' ? {flexDirection: 'column'} : {flexDirection: 'row'}]}>
        ...
        return (
            ...
            } : {flexDirection: 'row', height: this.state.customStyles.currentStepIndicatorSize}]}>
                {steps}
            </View>
        )
    };
    ...
    renderStepLabels = () => {
        ...
        return (
            <View style={[styles.stepLabelsContainer,
                direction === 'vertical' ? {flexDirection: 'column', paddingHorizontal: 4} : {
                    flexDirection: 'row',
                    paddingVertical: 4
                },
    ...
    renderStep = (position) => {
        ...
        const separatorStyle = (direction === 'vertical') ? {
