...
export default class HQStepIndicatorFixed extends Component {
...
HQStepIndicatorFixed.propTypes = {
    ...
    numberofStepsCompletedByDefault: PropTypes.number
};

HQStepIndicatorFixed.defaultProps = {
    stepCount: 5,
    customStyles: {},
    direction: 'horizontal',
    numberofStepsCompletedByDefault: 3
};
